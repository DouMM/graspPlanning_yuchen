"""
Visualize the predictions of a graspCNN on a dataset Visualizes TP, TN, FP, FN..
...
from graspNet import Grasp2D, graspCNN, ClassificationResult, InputDataMode, ImageMode, ImageFileTemplates
from graspNet import Visualizer as vis2d

import IPython

class graspCNNPredictionVisualizer(object):
    """ Class to visualize predictions of graspCNN on a specified dataset. Visualizes TP, TN, FP, FN. """
    ...
    def _setup(self):
        ...
        # load gqcnn
        logging.info('Loading grasp-CNN')
        self.model_dir = self.cfg['model_dir']
        self._gqcnn = graspCNN.load(self.model_dir)
