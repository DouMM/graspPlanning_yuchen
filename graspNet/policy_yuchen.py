...
from graspNet import Grasp2D, ImageGraspSamplerFactory, graspCNN, InputDataMode
from graspNet import visualizer_yuchen as vis
from graspNet import NoValidGraspsException
...
class AntipodalGraspingPolicy(GraspingPolicy):
    ...
    def _parse_config(self):
        ...
        #yuchen: change to 25
        self._num_grasp_samples = 25 #self.config['sampling']['num_grasp_samples']
