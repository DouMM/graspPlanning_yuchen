...
from graspNet.neural_networks_yuchen import graspCNN
from graspNet.sgd_optimizer_yuchen import SGDOptimizer
...
if __name__ == '__main__':
	...
	graspcnn = graspCNN(graspcnn_config)
	loadDataset_obj = loadDataset(train_config)
	sgdOptimizer = SGDOptimizer(graspcnn=graspcnn, loadDataset=loadDataset_obj, config=train_config)
